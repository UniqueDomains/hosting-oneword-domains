# Available .HOSTING One-Word Domains (30,719)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-1%2C000%20rows-8250df">
  <img alt="live catalog" src="https://img.shields.io/badge/live%20catalog-30%2C719%20domains-6f42c1">
...
> The full live catalog for this exact search currently contains **30,719 domains** on the canonical page below.

**Public extract:** 1,000 rows · **Live catalog:** 30,719 domains · **Median ask:** $341.62 · **High-demand under $2,500:** 68
...
| -------------- | --------- | --------- | ------------- | -------------- | ------ | ------ | --------- |
| here.hosting   | premium   | $1,690    | $1,690        | high           | medium | 4      | namecheap |
| steady.hosting | available | $309.99   | $329.99       | high           | low    | 6      | namesilo  |
| smooth.hosting | available | $309.99   | $329.99       | high           | low    | 6      | namesilo  |
| aaa.hosting    | available | $309.99   | $329.99       | medium         | medium | 3      | namesilo  |
| craft.hosting  | resell    | —         | —             | high           | medium | 5      | 1API GmbH |
| cake.hosting   | premium   | $1,729    | $1,729        | high           | low    | 4      | namesilo  |
| aft.hosting    | available | $309.99   | $329.99       | low            | low    | 3      | namesilo  |
| review.hosting | resell    | —         | —             | high           | medium | 6      | Epik LLC  |
| dick.hosting   | premium   | $1,729    | $1,729        | medium         | low    | 4      | namesilo  |
| all.hosting    | available | $309.99   | $429.99       | medium         | low    | 3      | namesilo  |
...
| due.hosting    | available | $309.99   | $429.99       | low            | low    | 3      | namesilo  |
| rise.hosting   | premium   | $1,729    | $1,729        | low            | low    | 4      | namesilo  |
...
| ----------------------- | ------------------------------------------ |
| 1,000-row public sample | 30,719 live domains                        |
...
> Unique Domains. *Available .HOSTING One-Word Domains*. Version 2026-09-23. Public GitHub extract for the exact Unique Domains search represented by this repository.
